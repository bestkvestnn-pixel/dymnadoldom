  ...
  const byChapter = {
    ...
    "chapter-2": [
      ...
      clue({
        ...
        possibleOwner: "Виктор Иванов",
        trueMeaning: "Виктор обронил уголок от пачки корма; сам по себе фрагмент почти неопознаваем.",
    ...
    "chapter-3": [
      ...
      clue({
        ...
        trueMeaning: "Виктор не работал в клинике в окна убийств.",
        firstThought: "Обычный рабочий график.",
        playerLaterUnderstands: "Это не доказывает присутствие на местах, но разрушает профессиональное алиби.",
        document: "табель смен / расписание приема ProЗрение",
        category: "финальная",
        opens: "Окна возможностей Виктора.",
        confirms: "Виктор не был на приеме в нужное время.",
        disproves: "рабочее алиби Виктора.",
