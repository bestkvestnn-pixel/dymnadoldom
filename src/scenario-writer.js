...
export function buildCaseFoundation(canon) {
  return {
    crime: {
      ...
      culprit: "Иванов Виктор Ильич.",
      why: "Серия Виктора строится вокруг табачного запаха/курения рядом, KAPNOS и постановочных следов."
    },
    hiddenTimeline: [
      {
        period: "За месяц",
        truth: "Виктор готовит серийный паттерн после ранних убийств. Его отпуск объясняет начало серии весной 2025 года и разницу между быстрым выбором Анны и пятимесячной слежкой за Мией; это позднее подтверждают рассказ Натальи и кадровое расписание. Газетный номер связывает дело Анны с выставкой Мии, где Виктор впервые пересекается с Мией.",
      ...
      },
      {
        ...
        truth: "Шторм в Озерске, матч в Новограде, записи камер и семейная версия накладываются на действия Виктора. Анна убита ножом с террасы. Услышав приезд Сергея, Виктор торопится вложить сигарету в руку Анны; когда он достает пачку KAPNOS, из кармана выпадает уголок пачки рыбного корма, которого он не замечает.",
        status: "подтверждено"
      },
      {
...
export function buildDeductionChain() {
  return [
    ...
    },
    {
      ...
      conclusion: "Слабая бытовая мелочь получает владельца только после сопоставления независимых документов; механизм падения связан с пачкой KAPNOS и спешкой после приезда Сергея.",
      nextClue: "Расписание ProЗрение, кадровые сведения об отпуске, рассказ Натальи и взломанная Павлом калитка.",
      nextConclusion: "Виктор не привязан к дому прямым свидетелем, но у него есть окно, способ входа, объясненный темп подготовки и материальная ошибка."
    },
    {
      clue: "Три настоящие жертвы: Морозов, Мия, Анна",
      conclusion: "Совокупность независимых слабых связей делает Виктора наиболее сильной версией, но еще не судебно доказанным виновным.",
      nextClue: "Сергей виновен в Веронике, но не в Анне.",
      nextConclusion: "Финал разводит семейную вину и серийную логику и обосновывает новое официальное расследование Виктора."
    }
  ];
}
...
function chapterPlanFor(id, chapter) {
  const plans = {
    "chapter-1": {
      ...
      materials: ["реестр материалов, переданных защите", "1-й допрос Сергея", "2-й допрос Сергея", "медицинские документы Анны", "фото Сергея с блондинкой", "сожженная рубашка"],
      facts: ["Помощники адвоката законно работают с копиями и выписками из материалов дела.", "Сергей скрывает Веронику так, будто защищает возможную соучастницу.", "Позднее выясняется, что Вероника мертва раньше Анны.", "Анна имела важные медицинские документы."],
    ...
    "chapter-2": {
      goal: "Игрок должен сменить метод расследования, проверить теорию Артура, исключить Крылова и добавить Анну к настоящей серии.",
      ...
      facts: ["Морозов связан с ProЗрение.", "Кристина подозрительна через переход из «Золотого квадрата» в ProЗрение и архивную CRM.", "Мия убита 19.02.2026, незадолго до суда над Сергеем.", "Сигарета у Мии вложена в правую руку, хотя Мия была левшой.", "Крылов отделяется другой маркой сигарет."],
    ...
    "chapter-3": {
      ...
      materials: ["акт осмотра взломанной калитки", "протокол ножа с террасы", "газетная реклама рыбного корма", "фото кабинета Виктора", "расписание и кадровые сведения ProЗрение", "рассказ Натальи об отпуске Виктора", "сводка по KAPNOS"],
      facts: ["Павел взломал калитку, но это не убийство.", "Виктор использовал нож с террасы.", "Уголок корма выпал из кармана Виктора, когда тот в спешке доставал пачку KAPNOS после приезда Сергея.", "Уголок связывается с Виктором через рекламу и фото кабинета.", "Виктор не работал в клинике в нужные окна, а отпуск объясняет темп серии.", "Сергей виновен в Веронике, а Виктор — в Анне."],
      newVersions: ["Виктор Иванов — наиболее сильная версия, требующая нового расследования"],
...
function strengthensFor(id) {
  return {
    kapnos: "Виктор как наиболее сильная версия серии",
    ...
    "clinic-schedule": "окно возможности Виктора без прямой привязки к месту",
...
function breaksFor(id) {
  return {
    ...
    "clinic-schedule": "версию, что рабочий график исключал возможность действий Виктора",
